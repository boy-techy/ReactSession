    ...
    render() {
        ...
        return (
            <div className="App">
                ...
                <List  item={this.state.item} incr={(index) => {this.incrementItem.bind(this)(index)}} decr={(index)=>{this.decrementItem.bind(this)(index)}} remove={(index)=>{this.removeItem.bind(this)(index)}}/>
